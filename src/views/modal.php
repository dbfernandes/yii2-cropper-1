    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLabel-<?= $unique ?>">
                    <?= $modalLabel ?>
                </h4>
            </div>
            <div class="modal-body">
                <div>
                    <img id="cropper-image-<?= $unique ?>" src="" alt="">
                </div>
            </div>
            <div class="modal-footer">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group input-group-sm width-warning">
                            <label class="input-group-addon" for="dataWidth-<?= $unique ?>">
                                <?= Yii::t('cropper', 'Width') ?> (<?= $cropWidth ?>px)
                            </label>
                    ...
                    <div class="col-sm-3">
                        <div class="input-group input-group-sm height-warning">
                            <label class="input-group-addon" for="dataHeight-<?= $unique ?>">
                                <?= Yii::t('cropper', 'Height') ?> (<?= $cropHeight ?>px)
                            </label>
                ...
                <div class="pull-left">
                    <span class="btn btn-primary btn-file"><?= $browseLabel ?><input type="file" id="cropper-input-<?= $unique ?>" title="<?= Yii::t('cropper', 'Browse') ?>" accept="image/*"></span>&nbsp;
                    <div class="btn-group">
